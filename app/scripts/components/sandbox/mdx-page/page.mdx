...
<Block type='full'>
  <Figure>
    <CompareImage 
      leftImage = {{
        src: "http://via.placeholder.com/256x128?text=left-left" ,
        alt: 'example left image for compare-image component ',
        label: 'left'
      }}
      rightImage = {{
        src: "http://via.placeholder.com/256x128?text=right-right",
        alt: 'example right image for compare-image component',
        label: 'right'
      }}
    />
