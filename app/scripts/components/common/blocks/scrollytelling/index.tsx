...
function Scrollytelling(props) {
  const {
    // Default environment variables for backward compatibility
      ...
      <ScrollyMapContainer topOffset={topOffset}>
        ...
        */}
        ...
        >
          ...
          <Basemap mapboxToken={mapboxToken} />
        </Map>
      </ScrollyMapContainer>
...
Scrollytelling.propTypes = {
  children: T.node,
  mapboxToken: T.string.isRequired,
  envApiStacEndpoint: T.string,
  envApiRasterEndpoint: T.string
};
