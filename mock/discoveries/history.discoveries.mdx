...
<Block type='wide'>
  <Figure>
    <Map datasetId='sandbox' layerId='no2-monthly' dateTime='2018-03-01' isComparing={true} />
    <Caption
      attrAuthor='somebody' 
...
<Image src="https://picsum.photos/id/107/5760/3840" align="center" alt="Tux, the Linux mascot" />
...
<Image src="http://via.placeholder.com/256x128?text=align-left" align="left" alt="Media example" caption="tux" 
  attrAuthor="penguin"
  attrUrl="https://linux.org" width="256" />
