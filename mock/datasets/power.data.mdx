...
name: 'POWER Meteorological Dataset'
featured: true
description: "Prediction of Worldwide Energy Resources (POWER)"
media:
...
layers:
  - id: power-meteorology-temperature
    ...
    zoomExtent:
      ...
      - 20
    sourceParams:
      url: s3://power-analysis-ready-datastore/power_901_monthly_meteorology_utc.zarr
