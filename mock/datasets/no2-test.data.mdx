...
featuredOn:
  - covid-19
id: no2-test
name: Nitrogen Dioxide Test
description: Since the outbreak of the novel coronavirus, atmospheric
  concentrations of nitrogen dioxide have changed by as much as 60% in some
  regions.
thematics:
  - agriculture
  - air-quality
...
layers:
  - sourceParams:
    ...
    type: raster
    id: no2-monthly
    description: Levels in 10¹⁵ molecules cm⁻². Darker colors indicate higher
      nitrogen dioxide (NO₂) levels associated and more activity. Lighter colors
      indicate lower levels of NO₂ and less activity.
    stacCol: no2-monthly
    zoomExtent:
      - 0
      - 20
