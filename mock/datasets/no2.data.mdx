...
usage:
  ...
  - url: 'https://daskhub.veda.smce.nasa.gov/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fnasa-impact%2Fveda-documentation&urlpath=lab%2Ftree%2Fveda-documentation%2Fsingle-item-viz.ipynb&branch=main'
    label: DaskHub
    title: 'Time series using STAC API statistics endpoints'
media:
