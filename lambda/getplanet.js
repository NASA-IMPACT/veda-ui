...
export function handler(event, context, callback) {
  ...
  const URL = `https://tiles0.planet.com/basemaps/v1/planet-tiles/global_monthly_${date}_mosaic/gmap/${z}/${x}/${y}.png?api_key=${PLANET_TOKEN}`;
